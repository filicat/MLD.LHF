...
using Kingdee.K3.MFG.SUB.App.ReportPlugIn.ROPickMtrl;
using System;
...
namespace MLD.LHF.MFG.SUB.App.ReportIn.ReportPlugIn.ROPickMtrl
{
    [Description("委外订单领料明细表二开添加字段"), HotUpdate]
    public class MLDROPickedDetailRpt : ROPickedDetailRpt
    {
